...
// ---------------------------------------------------------------------------
function mapEntityToSchema(obj, schema, state, config) {
    const rowData = {};
    const record = obj;
    if (!obj || typeof obj !== "object") {
...
// Track relationships for junction tables
// ---------------------------------------------------------------------------
function trackEntityRelationships(entity, entityType, entityId, schemas, state, config) {
