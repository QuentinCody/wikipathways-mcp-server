...
import type { SearchToolOptions, SearchToolResult } from "./search-core";
...
// Catalog mode now lives in its own module (this file was over the size cap).
// Declared as an import here rather than at the top of the file so the swap was a
// single compiling edit; ESM hoists it either way.
